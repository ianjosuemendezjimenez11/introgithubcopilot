...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique improvement, lap training and local meets",
    ...
    "Debate Team": {
        "description": "Prepare for and compete in regional and national debate tournaments",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["sophia.s@mergington.edu", "lucas@mergington.edu"]
    }
}
